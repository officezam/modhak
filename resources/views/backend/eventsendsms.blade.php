    ...
    <div class="">
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Send SMS <small>Today Event SMS Sending</small></h2>
            ...
            <div class="x_content">
              ...
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="last-name">
                <a href="{{ route('event_sending_sms') }}">
                <button type="button" class="btn btn-success btn-lg">Start Sending Event Sms To All Subscriber</button>
                </a>
              </label>
            </div>
          </div>
